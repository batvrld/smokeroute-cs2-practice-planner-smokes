...
Планировщик ручных тренировок и заметок по картам без вмешательства в игровой процесс.
...
- **Map drill library** — запланированный модуль; реализации нет.
- **Sensitivity comparison notes** — запланированный модуль; реализации нет.
- **Practice session log** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Map drill library**.
...
Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию Counter-Strike 2, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Sensitivity comparison notes

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию Counter-Strike 2, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Practice session log

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию Counter-Strike 2, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | Counter-Strike 2 |
| Категория | Ручные игровые помощники |
| Входные данные | Ручные записи или разрешенный пользователем локальный экспорт |
| Планируемый результат | Map drill library |
