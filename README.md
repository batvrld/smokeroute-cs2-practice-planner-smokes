...
<div align="center">
  <img src="./public/logo.svg" alt="SmokeRoute — Counter-Strike 2 — Smokes" width="64" height="64">
  <h1>SmokeRoute — Counter-Strike 2 — Smokes</h1>
</div>

An independent project specification for Counter-Strike 2, covering map drill library, sensitivity comparison notes, practice session log.
...
<img src="./public/screenshots/desktop-main.svg" alt="Counter-Strike 2 — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Counter-Strike 2 — compact concept, not a screenshot" width="250">
<br>
...
- **Map drill library** — planned module; not implemented.
- **Sensitivity comparison notes** — planned module; not implemented.
- **Practice session log** — planned module; not implemented.

The proposed workflow separates map drill library from sensitivity comparison notes, with practice session log retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Map drill library**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="SmokeRoute — Counter-Strike 2 — Smokes — specification review workflow">
<br>
...
Define the input and expected outcome for module 1. Record the Counter-Strike 2 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Sensitivity comparison notes

Define the input and expected outcome for module 2. Record the Counter-Strike 2 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Practice session log

Define the input and expected outcome for module 3. Record the Counter-Strike 2 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Map drill library |
